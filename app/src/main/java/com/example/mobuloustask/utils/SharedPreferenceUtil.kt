...
private constructor(val context: Context) {
    ...
    var userToken: String
        get() = sharedPreferences["userToken", ""]!!
        set(value) = sharedPreferences.set("userToken", value)
    ...
    var profile_id: Int
        get() = sharedPreferences["profile_id", 0]!!
        set(value) = sharedPreferences.set("profile_id", value)
    ...
    var blockType: String
        get() = sharedPreferences["blockType", ""]!!
        set(value) = sharedPreferences.set("blockType", value)
    ...
    var statusprofile: String
        get() = sharedPreferences["statusprofile", ""]!!
        set(value) = sharedPreferences.set("statusprofile", value)
...
//ibannumber
    ...
    var profileImg: String
        get() = sharedPreferences["profileImg", ""]!!
        set(value) = sharedPreferences.set("profileImg", value)
