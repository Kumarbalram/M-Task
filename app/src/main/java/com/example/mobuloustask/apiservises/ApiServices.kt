package com.example.mobuloustask.apiservises
...
import com.example.mobuloustask.network.NetworkConstants
...
interface ApiServices {
    ...
    @GET(NetworkConstants.POST_LIST)
    fun getPost(): Observable<PostListResponse>

    @GET(NetworkConstants.ALBUMS_LIST)
    fun getAlbums(): Observable<AlbumsListResponse>

    @GET(NetworkConstants.PHOTOS_LIST)
    fun getPhotos(): Observable<PhotosListResponse>
